...
<div class="stores-list bg-grey pdTop30"  id="allStores" >
  ...
  <div class="col-md-8">
          <div class="horiz-coupon-heading-box">
            <p class="abs text-center">


         
               <i class="fa fa-tag"></i> {{store.count.coupons}} Codes  <i class="fa fa-tags"></i> {{store.count.deals}} Deals 
                            </p>
       <!--      <a :href="base_url+'store/'+store.custom_url"  class="show_coupon text-center" >
              <h3>  {{store.name}}</h3>
            ...
            <a :href="base_url+'store/'+store.custom_url" target="_blank" class="show_coupon" data-id="11184" data-clipboard-text=" ">
               <p class="btn-code" data-type="deal"> 
                  <span class="btn-hover fix-btn text-center">Visit</span> 
               </p>
            </a>
          </div>
         ...
         <li     v-for="store in allStores" >
          <center>
             <a :href="base_url+'store/'+store.custom_url">
              ...
              <img  v-bind:src="api_url+'/assets/uploads/stores/'+store.feature_image" v-bind:alt="store.name" :alt="store.name"   width="100" height="100" class="tile-block-logo-image lazyloaded" draggable="false" style="    border-radius: 12px;" ><br>
              

                <!-- <STRONG>&nbsp</STRONG>  -->
<br>
<sup   >{{store.count.coupons}} offers 
  <!-- <hr> {{store.name}} -->
</sup> 
