...
$profile=getUserProfile();
		if(empty($profile->feature_image)){
				$profile->feature_image='blank.png';
		}
...
?>
    ...
    <div class="offcanvas-content pr-5 mr-n5">
        ...
        <div class="d-flex align-items-center mt-5">
            <div class="symbol symbol-100 mr-5">
                <div class="symbol-label" style="background-image:url('<?=base_url()?>/assets/uploads/users/<?=$profile->feature_image?>')"></div>
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <circle fill="#000000" opacity="0.3" cx="19.5" cy="17.5" r="2.5"/>
					...
					<a href="<?=base_url()?>Authentication/logout/" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">Sign Out</a>
                </div>
            </div>
        </div>
		<!--end::Header-->
