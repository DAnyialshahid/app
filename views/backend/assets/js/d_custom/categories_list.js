            ...
            }, 
            {
                ...
                template: function(row) {
                    return '\
								...
								<a href="javascript:;" class="btn btn-sm btn-clean btn-icon mr-1" data-toggle="dropdown">\
							  	...
							  	<div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">\
	                                <ul class="navi flex-column navi-hover py-2">\
	                                    ...
	                                    <li class="navi-item">\
	                                        <a href="#" class="navi-link" onclick="F.copyThis('+row.id+',\'copyCategories\')">\
                            ...
                            <a href="javascript:;"  onclick="F.copyThis('+row.id+',\'copyCategories\')" class="btn btn-sm btn-clean btn-icon mr-1" title="Edit details">\
                                <span class="svg-icon svg-icon-md">\
                                 <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">\
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">\
                                            <rect x="0" y="0" width="24" height="24"/>\
