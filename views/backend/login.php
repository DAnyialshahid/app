    ...
    <head><base href="../../../">
        ...
        <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Poppins:300,400,500,600,700"/>        <!--end::Fonts-->
                    ...
                    <!--begin::Page Custom Styles(used by this page)-->
                             <link href="<?=backend_base_url?>/assets/css/pages/login/login-2.css" rel="stylesheet" type="text/css"/>
...
<div class="login login-2 login-signin-on d-flex flex-column flex-lg-row flex-column-fluid bg-white" id="kt_login">
                    ...
                    <form class="form" novalidate="novalidate"  action="#"  id="kt_login_signin_form">
                       ...
                       <input type="hidden" name="<?= $this->security->get_csrf_token_name()?>" id="token" value="<?= $this->security->get_csrf_hash()?>"/>
                        ...
                        <div class="text-center pt-2">
                            <button id="kt_login_signin_submit" type="button" class="btn btn-dark font-weight-bolder font-size-h6 px-8 py-4 my-3">Sign In</button>
                        </div>
                        <!--end::Action-->
                    </form>
                    <!--end::Form-->
    ...
    <div class="content order-1 order-lg-2 d-flex flex-column w-100 pb-0" style="background-color: #B1DCED;">
        ...
        <!--begin::Image-->
        <div class="content-img d-flex flex-row-fluid bgi-no-repeat bgi-position-y-bottom bgi-position-x-center" style="background-image: url(<?=backend_base_url?>/assets/media/svg/illustrations/login-visual-2.svg);"></div>
        <!--end::Image-->
    </div>
    <!--end::Content-->
</div>
    	...
    	<!--begin::Global Theme Bundle(used by all pages)-->
				...
				<!--end::Global Theme Bundle-->
                        ...
                        <!--begin::Page Scripts(used by this page)-->
                            <script src="<?=backend_base_url?>/assets/js/d_custom/login.js"></script>
                        <!--end::Page Scripts-->
            </body>
    <!--end::Body-->
</html>