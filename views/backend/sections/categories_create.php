                ...
                <div class="card card-custom">
                    ...
                    <div class="card-header flex-wrap border-0 pt-6 pb-0">
                        ...
                        <div class="card-toolbar">
                            <!--begin::Button-->
                            <a onclick="Route.go('categories','list')"  class="btn btn-primary font-weight-bolder">
                    ...
                    <div class="card-body row">
                        <div class="col-md-6 col-xl-6 col-xxl-6">
                            ...
                            <!--begin::Group-->
                            <div class="form-group row">
                                <label class="col-xl-3 col-lg-3 col-form-label">Category  Slug</label>
                                <div class="col-lg-9 col-xl-9">
        ...
        <div class="col-md-6 col-xl-6 col-xxl-6">
            ...
            <!--end::Group-->
                    ...
                    <div class="card-footer d-flex justify-content-end">
                        <div>
                            <!--begin::Button-->
                            <a href="#"  onclick="Main.submit({path1:'categories',path2:'list'})"  class="btn btn-light-primary font-weight-bolder pulse pulse-primary">
                                <span class="svg-icon svg-icon-md">
