                    ...
                    <div class="card-body row">
                        <div class="col-md-6 col-xl-6 col-xxl-6">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9 col-xl-9">
                                    <input class="form-control form-control-solid form-control-lg"  name="password" id="password" type="text" value="" />
                                </div>
                            </div>
                            <!--end::Group-->        
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9 col-xl-9">
                                    <input class="form-control form-control-solid form-control-lg"  name="email" id="email" type="text" value="" />
                                </div>
                            </div>
                            <!--end::Group-->  
                            <!--begin::Group-->
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9 col-xl-9">
                                    <input class="form-control form-control-solid form-control-lg  " name="first_name"  id="first_name" type="text" value="" />
                                </div>
                            </div>
                            <!--end::Group-->                   
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9 col-xl-9">
                                    <input class="form-control form-control-solid form-control-lg  " name="last_name"  id="last_name" type="text" value="" />
                                </div>
                            </div>
                            <!--end::Group-->   
...
<!--begin::Group-->
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9 col-xl-9">
                                    <input class="form-control form-control-solid form-control-lg  " name="contact"  id="contact" type="text" value="" />
                                </div>
                            </div>
                            <!--end::Group-->   
                        ...
                        <div class="col-md-6 col-xl-6 col-xxl-6">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9 col-xl-9">
                                    ...
                                    <span class="form-text text-muted">Current status of user active / deactive</span>
                                </div>
                            </div>
                            <!--end::Group-->
                            ...
                            <!--end::Group-->
                             ...
                             <!--begin::Group-->
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-9">
                                        <select class="form-control " name="site_id" id="select_site">
