                ...
                <div class="card card-custom">
                    ...
                    <div class="card-header flex-wrap border-0 pt-6 pb-0">
                        ...
                        <div class="card-toolbar">
                            <!--begin::Button-->
                            <a onclick="Route.go('pages','list')"  class="btn btn-primary font-weight-bolder">
        ...
        <div class="col-md-6 col-xl-6 col-xxl-6">
            ...
            <!--end::Group-->
                    ...
                    <div class="card-footer d-flex justify-content-end">
                        <div>
                            <!--begin::Button-->
                            <a href="#" onclick="Main.submit({path1:'pages',path2:'list'})" class="btn btn-light-primary font-weight-bolder pulse pulse-primary">
                                <span class="svg-icon svg-icon-md">
