<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="d-flex flex-column-fluid">
                ...
                <div class="card card-custom">
                    ...
                    <div class="card-header flex-wrap border-0 pt-6 pb-0">
                        ...
                        <div class="card-toolbar">
                            <!--begin::Button-->
                            <a href="<?=base_url()?>admin/sliders/list" class="btn btn-primary font-weight-bolder">
                    ...
                    <div class="card-body row">
                        <div class="col-md-6 col-xl-6 col-xxl-6">
                            ...
                            <div class="form-group row">
                                ...
                                <label class="col-xl-2 col-lg-2 col-form-label">Type</label>
                                <div class="col-lg-4 col-xl-4"> 
                        ...
                        <div class="col-md-6 col-xl-6 col-xxl-6">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-7 col-xl-7">
                                  ...
                                  <!--begin::Button-->
                                     <a href="#slideTemplete" class="btn btn-primary font-weight-bolder" onclick="addSlide()">  
                                        Add Slide 
                                     </a>
                                 <!--end::Button-->
       ...
       <!--begin::Slides-->                       
<div class="col-md-12 col-xl-12 col-xxl-12 row" id="slides" ></div>          <!--end::Slides-->
                    ...
                    <div class="card-footer d-flex justify-content-end">
                        <div>
                            <!--begin::Button-->
                            <a href="#"  onclick="Main.submit('<?=base_url()?>admin/sliders/list')"  class="btn btn-light-primary font-weight-bolder pulse pulse-primary">
                                <span class="svg-icon svg-icon-md">
...
<div id="slideTemplete" class="d-none">
                        ...
                        <div class="col-md-6 col-xl-6 col-xxl-6">
                                   ...
                                   <!--begin::Group-->
                            <div class="form-group row">
                                <label class="col-xl-3 col-lg-3 col-form-label">Slider Link</label>
                                <div class="col-lg-9 col-xl-9">
                                    <input class="form-control form-control-solid form-control-lg  slider_link"  name="slider_link[]" type="text" value="" />
                                </div>
                            </div>
                            <!--end::Group-->  
                        ...
                        <div class="col-md-6 col-xl-6 col-xxl-6">
                            ...
                            <!--begin::Group-->
                            <div class="form-group row">
                                <label class="col-xl-3 col-lg-3 col-form-label text-left">Slide  Image</label>
                                <div class="col-lg-6 col-xl-6"> 
                                    <div class="image-input image-input-outline" >
                                        ...
                                        <label class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow" data-action="change" data-toggle="tooltip" title="" data-original-title="Change avatar">
                                            ...
                                            <input type="file" class="feature_image" name="feature_image[]" accept=".png, .jpg, .jpeg"/>
                                     ...
                                     <!--begin::Button-->
                                     <button  class=" btn btn-primary font-weight-bolder" onclick="$(this).parent().parent().parent().parent().remove()">  
                                        Delete Slide 
                                  </button>
                                      </div>
                                 <!--end::Button-->
