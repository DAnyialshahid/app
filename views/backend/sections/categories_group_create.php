 <!--begin::Container-->
                ...
                <div class="card card-custom">
                    ...
                    <div class="card-header flex-wrap border-0 pt-6 pb-0">
                        ...
                        <div class="card-toolbar">
                            <!--begin::Button-->
                            <a onclick="Route.go('categories_group','list')"  class="btn btn-primary font-weight-bolder">
                    ...
                    <div class="card-body row">
                        <div class="col-md-6 col-xl-6 col-xxl-6">
                            ...
                            <!--begin::Group-->
                            <div class="form-group row">
                                <label class="col-xl-3 col-lg-3 col-form-label">Group  Slug</label>
                                <div class="col-lg-9 col-xl-9">
                            ...
                            <!--begin::Group-->
                            <div class="form-group row">
                                <label class="col-xl-3 col-lg-3 col-form-label">Group  Icon</label>
                                <div class="col-lg-9 col-xl-9">
                                    ...
                                    <select class="form-control selectpicker" id="icon" name="icon">
                                                    ...
                                                    <?php backend_page($this,'sections/select_box_icon_options')?>
                            ...
                            <!--begin::Group-->
                            <div class="form-group row">
                                <label class="col-xl-3 col-lg-3 col-form-label text-left">Group  Image</label>
                                <div class="col-lg-9 col-xl-9"> 
    ...
    <div class="col-md-12 col-xl-12 col-xxl-12 row">
        <h5 class="col-md-12 col-xl-12 col-xxl-12 text-dark font-weight-bold mb-10">Category Group SEO</h5>
        <!--begin::Group-->

        <div class="col-md-6 col-xl-6 col-xxl-6">
            <!--begin::Group-->
            <div class="form-group row">
                <label class="col-xl-3 col-lg-3 col-form-label"> Group Meta title </label>
                <div class="col-lg-9 col-xl-9">
                    <input class="form-control form-control-solid form-control-lg" name="seo_category_group_meta_title" type="text" value="" />
                </div>
            </div>
            <div class="form-group row">
                <label class="col-xl-3 col-lg-3 col-form-label"> Group Meta Keywords </label>
                <div class="col-lg-9 col-xl-9">
                    <input class="form-control form-control-solid form-control-lg" name="seo_category_group_meta_keywords" type="text" value="" />
                </div>
            </div>
            <!--end::Group-->
        </div>
        <div class="col-md-6 col-xl-6 col-xxl-6">
            <!--begin::Group-->
            <div class="form-group row">
                <label class="col-xl-3 col-lg-3 col-form-label">Group Meta Description</label>
                <div class="col-lg-9 col-xl-9">
                    <textarea name="seo_category_group_meta_description" style="width: 100%; height: 130px;"></textarea>
                </div>
            </div>
            <!--end::Group-->
        </div>
                    ...
                    <div class="card-footer d-flex justify-content-end">
                        <div>
                            <!--begin::Button-->
                            <a href="#"  onclick="Main.submit({path1:'categories_group',path2:'list'})"  class="btn btn-light-primary font-weight-bolder pulse pulse-primary">
                                <span class="svg-icon svg-icon-md">
