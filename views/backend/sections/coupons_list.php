...
<!--begin::Button-->
<a href="#" onclick="F.pasteClipboard('Coupons')" class="btn btn-light font-weight-bolder mr-2">
            ...
            <div class="row align-items-center">
            	<div class="col-md-3 my-2 my-md-0">
                    ...
                    <div class="col-md-3 my-2 my-md-0">
                              ...
                              <a href="javascript:;" onclick="Main.deleteAllSelected(746611)" class="btn  font-weight-bolder btn-danger" title="Delete Coupon">	                             
	 <h3 class=" la la-trash text-white">&nbsp;</h3> Delete Selected Coupons
