                                    ...
                                    <div class="tw-flex tw-leading-tight tw-w-5/6 sm:tw-ml-6 tw-ml-4">
                                        <div class="tw-flex-grow tw-pr-4 coupon-card-inner-container">
                                          <div class="row">
                                            ...
                                            <div v-if="coupon.verified!=0" class="col-xs-2 tw-text-green sm:tw-border sm:tw-border-green sm:tw-text-green sm:tw-text-base tw-text-xs lato sm:tw-rounded sm:tw-px-2 sm:tw-py-1" style="    padding: 2px; margin: 3px; text-align: center;"> Verified </div> <div v-if="coupon.exclusive!=0" class="col-xs-2 tw-text-blue sm:tw-border sm:tw-border-blue sm:tw-text-blue sm:tw-text-base tw-text-xs lato sm:tw-rounded sm:tw-px-2 sm:tw-py-1" style=" padding: 2px; margin: 3px; text-align: center;"> Exclusive </div>
                                            <div v-if="coupon.featured!=0" class="col-xs-2 tw-text-orange sm:tw-border sm:tw-border-orange sm:tw-text-orange sm:tw-text-base tw-text-xs lato sm:tw-rounded sm:tw-px-2 sm:tw-py-1" style=" padding: 2px; margin: 3px; text-align: center;"> Featured </div> 
                                          </div>
